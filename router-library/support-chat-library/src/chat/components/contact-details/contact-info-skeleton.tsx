    ...
    <div className="p-4">
      <div className="flex flex-col items-center pb-6 border-b">
        ...
        <div className="flex items-center mt-1">
          <div className="h-2 w-2 rounded-full bg-gray-300 animate-pulse mr-1" />
      ...
      <div className="py-4 space-y-4">
        <div>
          <div className="h-4 w-32 bg-gray-300 animate-pulse rounded mb-4" />
        ...
        <div>
          <div className="h-4 w-28 bg-gray-300 animate-pulse rounded mb-4" />
          <div className="space-y-3">
            <div className="flex justify-between">
